...
CODES = {
    ...
    "Ghana": "gh",
    # non-finalist nations (so recent-form opponents etc. still get a flag)
    "Andorra": "ad", "Aruba": "aw", "Bermuda": "bm", "Bolivia": "bo",
    "Burundi": "bi", "Cameroon": "cm", "Chile": "cl", "China": "cn",
    "Costa Rica": "cr", "Denmark": "dk", "Dominican Republic": "do",
    "El Salvador": "sv", "Finland": "fi", "Gabon": "ga", "Gambia": "gm",
    "Greece": "gr", "Guatemala": "gt", "Honduras": "hn", "Iceland": "is",
    "Italy": "it", "Jamaica": "jm", "Kosovo": "xk", "Madagascar": "mg",
    "Mali": "ml", "Mauritania": "mr", "Nicaragua": "ni", "Nigeria": "ng",
    "North Macedonia": "mk", "Northern Ireland": "gb-nir", "Peru": "pe",
    "Poland": "pl", "Puerto Rico": "pr", "Republic of Ireland": "ie",
    "Romania": "ro", "Russia": "ru", "Serbia": "rs", "Slovenia": "si",
    "Syria": "sy", "Trinidad and Tobago": "tt", "Ukraine": "ua",
    "Venezuela": "ve", "Wales": "gb-wls", "Zambia": "zm",
    # broader buffer (other FIFA members that may appear in form/H2H)
    "Albania": "al", "Angola": "ao", "Armenia": "am", "Azerbaijan": "az",
    "Belarus": "by", "Benin": "bj", "Bulgaria": "bg", "Burkina Faso": "bf",
    "Comoros": "km", "Congo": "cg", "Cuba": "cu", "Cyprus": "cy",
    "Equatorial Guinea": "gq", "Estonia": "ee", "Eswatini": "sz",
    "Ethiopia": "et", "Faroe Islands": "fo", "Georgia": "ge", "Guinea": "gn",
    "Guinea-Bissau": "gw", "Hungary": "hu", "India": "in", "Indonesia": "id",
    "Israel": "il", "Kazakhstan": "kz", "Kenya": "ke", "Kuwait": "kw",
    "Latvia": "lv", "Lebanon": "lb", "Liberia": "lr", "Libya": "ly",
    "Lithuania": "lt", "Luxembourg": "lu", "Malawi": "mw", "Malaysia": "my",
    "Malta": "mt", "Mauritius": "mu", "Moldova": "md", "Montenegro": "me",
    "Mozambique": "mz", "Namibia": "na", "Niger": "ne", "Oman": "om",
    "Palestine": "ps", "Philippines": "ph", "Sierra Leone": "sl",
    "Slovakia": "sk", "Sudan": "sd", "Tanzania": "tz", "Thailand": "th",
    "Togo": "tg", "Uganda": "ug", "United Arab Emirates": "ae",
...
# A gold globe lifted on a trophy stand (a nod to the World Cup trophy that holds
# up the Earth), on a dark rounded tile — a self-contained data URI so the SAME
# favicon shows on every page (the dashboards live in sub-folders, so a relative
